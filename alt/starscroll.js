...
$.fn.starscroll = function(bit,fields,num,size,speed,smooth,colour,mix,anim){ // 8bit mode 
...
Plugin.prototype.drawStar = function(ctx,i,hsl){
	...
	var z = this.dimension / (i*.075 +1.4),
...
Plugin.prototype.colstep = function(hsl){
	...
	hsl[0] = hsl[0] - (~~(Math.random()*3)) + (~~(Math.random()*6));
